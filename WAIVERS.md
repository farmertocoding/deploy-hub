...
WAIVED: frontend/src/App.jsx | UX-F8-SIMULATION-STATES | demo pane does not subscribe to site. or deploy. topics — Task 20 is seed-only; screens are Phase 3. Named UX-F8 tests never claimed a pane. (2026-08-21)
WAIVED: simulation/seed_v0.json | review3-N2 | warming event omits elapsed and expected — seed token is present; elapsed/expected copy waits for the site-card UI. (2026-08-21)
WAIVED: deploys/breakglass.py | SEC-P5 | runbook lacks impact line and executable DNS — commands + 0400 + no secrets hold; impact/DNS copy is Phase 3 operator UX. (2026-08-21)
